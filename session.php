...
<form class="login-form" action="ResConf.php" method='post'>
      <div class="login-wrap">
        ...
        <div class="input-group">
          ...
          <input type="text" class="form-control" name="name" placeholder="Name Session" autofocus>
          <input type="text" class="form-control" name="location" placeholder="location Session" autofocus>
         <input type="Date" class="form-control" name="dates" placeholder="dateStart" autofocus>
          <input type="Date" class="form-control" name="datee" placeholder="dateEnd" autofocus>
          
        </div>
     
       
        <button class="btn btn-primary btn-lg btn-block" type="submit">Ajouter Session</button>
