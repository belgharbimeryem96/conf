                ...
                <div class="form">
                  <form class="form-validate form-horizontal" id="feedback_form" method="get" action="" novalidate="novalidate">
                    <div class="form-group ">
                      <label for="ctype" class="control-label col-lg-2">Type of sponsor <span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class="form-control" id="cname" name="type" minlength="5" type="text" required="">
                      </div>

                       <label for="cname" class="control-label col-lg-2">Name of organisation <span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class="form-control" id="cname" name="nameOrganisation" minlength="5" type="text" required="">
                      </div>


                       <label for="curl" class="control-label col-lg-2">URL of organisation <span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class="form-control" id="cname" name="url" minlength="5" type="text" required="">
                      </div>
                     ...
                     <div class="form-group ">
                      ...
                      <div class="form-group ">
                      <label for="cposition" class="control-label col-lg-2">Position of type or sponsor</label>
                      <div class="col-lg-10">
                      ...
                      <label for="cheight" class="control-label col-lg-2">Image height(pixels)</label>
                      <div class="col-lg-10">
                        <input class="form-control " id="cheigh" minlength="5" name="comment" required="">
                      </div>

                      <label for="cwidth" class="control-label col-lg-2">Image width(pixels)</label>
                      <div class="col-lg-10">
                        <input class="form-control " id="cwid"  minlength="5" name="comment" required="">
                      </div>
                    </div>
